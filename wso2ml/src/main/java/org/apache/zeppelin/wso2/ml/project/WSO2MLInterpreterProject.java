...
package org.apache.zeppelin.wso2.ml.project;
 ...
 *
 */
public class WSO2MLInterpreterProject extends Interpreter {
  private Logger logger = LoggerFactory.getLogger(WSO2MLInterpreterProject.class);
  ...
  static {
    Interpreter.register("project", "wso2ml", WSO2MLInterpreterProject.class.getName());
  }

  public WSO2MLInterpreterProject(Properties property) {
    super(property);
  ...
  public InterpreterResult interpret(String cmd, InterpreterContext contextInterpreter) {
    ...
    URL dataFile = classLoader.getResource("mlwidget_project.ftl");
    ...
    boolean flag = true;
    List<String> list = WSO2MLInterface.getListOfProjects();
    ...
    list = WSO2MLInterface.getListOfDataSets();
    ...
    if(flag) {
      ...
      try {
        Template temp = cfg.getTemplate("mlwidget_project.ftl");
...
//              + "|" + res.message());
  ...
  public Scheduler getScheduler() {
    return SchedulerFactory.singleton().createOrGetFIFOScheduler(
            WSO2MLInterpreterProject.class.getName() + this.hashCode());
  }
