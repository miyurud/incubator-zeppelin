...
package org.apache.zeppelin.wso2.ml.analysis;
 ...
 *
 */
public class WSO2MLInterpreterAnalysis extends Interpreter {
  private Logger logger = LoggerFactory.getLogger(WSO2MLInterpreterAnalysis.class);
  ...
  static {
    Interpreter.register("analysis", "wso2ml", WSO2MLInterpreterAnalysis.class.getName());
  }

  public WSO2MLInterpreterAnalysis(Properties property) {
    super(property);
  ...
  public InterpreterResult interpret(String cmd, InterpreterContext contextInterpreter) {
    ...
    URL dataFile = classLoader.getResource("mlwidget_analysis.ftl");
    ...
    boolean flag = true;
    List<String> list = WSO2MLInterface.getListOfAlgorithms();
    ...
    list = WSO2MLInterface.getListOfProjects();
    ...
    if(flag) {
      ...
      try {
        Template temp = cfg.getTemplate("mlwidget_analysis.ftl");
  ...
  public Scheduler getScheduler() {
    return SchedulerFactory.singleton().createOrGetFIFOScheduler(
            WSO2MLInterpreterAnalysis.class.getName() + this.hashCode());
  }
